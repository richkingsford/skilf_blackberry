...
const publicChecks = [
  { path: "/", text: "HighBar" },
  { path: "/interns.html", text: "applicant" },
  { path: "/privacy.html", text: "Only active registered applicants, mentors, and board members can send messages" },
  { path: "/admin.html", text: "Permissions and account safety" },
];

const manualChecks = [
  "Sign out and sign back in on production as richkingsford@gmail.com.",
  "Confirm Rich can see Admin, Applicant Dashboard, Board Dashboard, and Mentor Dashboard in the footer and profile menu.",
  ...
  "Send one Applicants page message and confirm Firestore plus email delivery.",
